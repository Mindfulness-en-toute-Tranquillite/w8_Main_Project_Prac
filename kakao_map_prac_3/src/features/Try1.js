...
export default function WriteMapPage(props) {
  useEffect(() => {
    ...
    script.src =
    `//dapi.kakao.com/v2/maps/sdk.js?autoload=false&appkey=${process.env.NEXT_PUBLIC_KAKAOMAP_KEY}&libraries=services,clusterer,drawing`;
  ...
  return (
    <div className="map_wrap" isOpen={isOpen}>
      <div id="map"></div>
